...
Vagrant.configure("2") do |config|
    config.vm.define "xiaofeng-ekf" do |vconfig|
    ...
    config.vm.define "xiaofeng-ekf-xfce" do |vconfig|
        vconfig.vm.provider "virtualbox" do |v, override|
            v.cpus = 3
            v.gui = true
            v.linked_clone = true
    ...
    config.vm.define "ros-vagrant" do |vconfig|
    ...
    config.vm.define "rv-client" do |vconfig|
        vconfig.vm.provider "docker" do |d, override|
            d.build_dir = "."
    ...
    config.vm.define "ros-vagrant-xfce" do |vconfig|
        vconfig.vm.provider "docker" do |d, override|
            d.build_dir = "."
            d.dockerfile = "Xfce.Dockerfile"
            d.create_args = ["--restart", "unless-stopped", "--add-host", "firmware.ardupilot.org:127.0.0.1", "--env", "RV_XFCE=1"]
            d.name = "ros-vagrant-xfce"
            d.ports = ["11311:11311"]
            override.vm.synced_folder "catkin_ws/", "/home/ros/catkin_ws"
        end
    end
    config.vm.define "rv-client-xfce" do |vconfig|
        vconfig.vm.provider "docker" do |d, override|
            d.build_dir = "."
            d.dockerfile = "Xfce.Dockerfile"
